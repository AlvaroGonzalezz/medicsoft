...
<body class="form-v10">
	<h1>Registro</h1>
	<p>Registra tu información con tranquilidad, nuestro sistema es totalmente seguro. Si ya te has registrado inicia sesión pulsando <a href="login.php">aquí</a></p>
