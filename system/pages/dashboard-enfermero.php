...
$nombreEnfermero = isset($_SESSION['nombre']) ? $_SESSION['nombre'] : 'Enfermero';
...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link  active" href="../pages/dashboard-enfermero.php">
                        <div
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        ...
                        <li class="nav-item d-flex align-items-center">
                            <a href="javascript:;" class="nav-link text-body font-weight-bold px-0">
                                ...
                                <span
                                    class="d-sm-inline d-none"><?php echo htmlspecialchars($nombreEnfermero); ?></span>
                            </a>
                        </li>
        ...
        <div class="container-fluid py-4">
            <h4 class="mb-4">¡Hola <?= $nombreEnfermero?>! 👋</h4>
            <div class="row">
                <div class="col-lg-6 col-12">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-12">
                            <a class="card-green" href="pacientes-enfermero.php">
                                <div class="card">
                                    ...
                                    <div class="card-body p-3 position-relative">
                                        <div class="row">
                                            <div class="col-8 text-start">
                                                ...
                                                <span class="text-white text-sm">Gestionar a mis pacientes</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                  ...
                  <div class="card-body p-3 position-relative">
                    <div class="row">
                      <div class="col-8 text-start">
                        ...
                        <h5 class="text-white font-weight-bolder mb-0 mt-3">
                          Mis Tareas</h5>
                        <span class="text-white text-sm">Mira todas tus tareas realizadas cada día</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card-body p-3 position-relative">
                    <div class="row">
                      <div class="col-8 text-start">
                        ...
                        <span class="text-white text-sm">Mantén el seguimiento médico de quienes más quieres.</span>
                      </div>
                    </div>
                  </div>
                </div>
                        ...
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-lg-6 d-flex flex-column justify-content-center">
                                    ...
                                    <div class="mb-3">
                                        <select class="form-control mt-3" id="tipoConsulta" onchange="cambiarIcono()"
                                            required>
                                            <option value="fuera" <?= $estadoLaboral == 'fuera' ? 'selected' : '' ?>>
                                                Fuera de Servicio</option>
                                            <option value="en" <?= $estadoLaboral == 'en' ? 'selected' : '' ?>>En
                                                Servicio</option>
                                        </select>
                                    </div>
                                    <button type="button" class="btn btn-primary"
                                        onclick="actualizarEstado(<?= $usuarioId ?>)">Actualizar Estado</button>
                                </div>
                                ...
                                <div class="col-lg-5 ms-auto text-center mt-5 mt-lg-0">
                                    <div class="bg-primary border-radius-lg h-100">
                                        ...
                                        <div
                                            ...
                                            <i id="iconoEstado" style="color: aliceblue; font-size: 80px;"
    ...
    function actualizarEstado(usuarioId) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = 'actualizar_estado.php?estado=' + encodeURIComponent(
                    estadoSeleccionado) + '&id=' + usuarioId;
            }
        });
    }
