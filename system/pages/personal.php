...
<body class="g-sidenav-show bg-gray-100">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Personal Médico</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Personal Médico</h6>
        </nav>
    ...
    <div class="container-fluid py-4">
      <div class="row">
        <div class="col-12">
          ...
          <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#guardarEnfermeroModal">
            <i class="bi bi-plus"></i> Nuevo Enfermero</button>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Fecha de
                        nacimiento</th>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Estado laboral
                      </th>
  ...
  <!-- Modal -->
  <div class="modal fade" id="guardarEnfermeroModal" tabindex="-1" aria-labelledby="guardarEnfermeroModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">

        <div class="modal-header">
          <h5 class="modal-title" id="guardarEnfermeroModalLabel">Agregar Nuevo Enfermero 🥼</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
        </div>
