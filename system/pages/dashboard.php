                    ...
                    <div class="row">
                      <div class="col-8 text-start">
                        <div class="icon icon-shape bg-white shadow text-center border-radius-2xl">
                          <i style="color: #30807a;" class="bi bi-calendar-date-fill"></i>
                        </div>
                        <h5 class="text-white font-weight-bolder mb-0 mt-3">
                          Citas Médicas
                        </h5>
                        <span class="text-white text-sm">Agendar o ver mis citas</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card-body p-3 position-relative">
                    <div class="row">
                      <div class="col-8 text-start">
                        ...
                        <h5 class="text-white font-weight-bolder mb-0 mt-3">
                          Mi Seguimiento Hospitalario</h5>
                        <span class="text-white text-sm">Mira el historial de tus procedimientos</span>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <!-- <div class="col-lg-6 col-12 mt-4 mt-lg-0">
          <div class="card shadow h-100">
            ...
            <div class="card-body pb-0 p-3">
              <ul class="list-group">
                <li class="list-group-item border-0 d-flex align-items-center px-0 mb-0">
                  <div class="w-100">
                    <div class="d-flex mb-2">
                      <span class="me-2 text-sm font-weight-bold text-dark">Paracetamol 500mg - 1 c/día por 3 días
                      </span>
                ...
                <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
                  <div class="w-100">
                    <div class="d-flex mb-2">
                      <span class="me-2 text-sm font-weight-bold text-dark">Amoxicilina 500mg - 1 c/día por 10
                        días</span>
                ...
                <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
                  <div class="w-100">
                    <div class="d-flex mb-2">
                      <span class="me-2 text-sm font-weight-bold text-dark">Loratadina 10mg - 1 c/día por 20 días</span>
            ...
            <div class="card-footer pt-0 p-3 d-flex align-items-center">
              <div class="w-70">
                <p class="text-sm">
                  Lleva el control de tus medicinas de forma fácil. Aquí puedes ver qué te toca tomar, a qué hora y
                ...
                <div class="col-lg-5 ms-auto text-center mt-5 mt-lg-0">
                  <div class="bg-primary border-radius-lg h-100">
                    ...
                    <div class="position-relative d-flex align-items-center justify-content-center h-100">
                      <i style="color: aliceblue; font-size: 80px;" class="bi bi-person-check-fill"></i>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-lg-6">
                  <div class="d-flex flex-column h-100">
                    <p class="mb-1 pt-2 text-bold">Salud</p>
                ...
                <div class="col-lg-5 ms-auto text-center mt-5 mt-lg-0">
                  <div class="bg-primary border-radius-lg h-100">
                    <img src="../assets/img/shapes/waves-white.svg"
                      class="position-absolute h-100 w-50 top-0 d-lg-block d-none" alt="waves">
                    <div class="position-relative d-flex align-items-center justify-content-center h-100">
                      <i style="color: aliceblue; font-size: 80px;" class="bi bi-file-earmark-person-fill"></i>
                    </div>
                  </div>
                </div>
              </div>
