...
<body class="g-sidenav-show bg-gray-100">
        ...
        <div class="container-fluid py-4 ">
          <div class="col-12">
            ...
            <div class="card mb-4">
              ...
              <div class="card-body px-4 pt-0 pb-2">
                <div class="row">
                  <div class="coments" id="comentarios">
                    <?php
                    // Mostrar todos los comentarios del paciente
                  ...
                  <div class="mb-3 mt-5">
                    ...
                    <?php if ($rol == 'Enfermero' || $rol == 'Paciente' || $rol == 'Medico'): ?>
                      ...
                      <form action="guardar_comentario.php" method="POST" enctype="multipart/form-data">
                        ...
                        <button type="submit" class="btn btn-primary w-50"><i class="bi bi-chat-left-text-fill"></i> Comentar</button>
                      </form>
                    <?php endif; ?>
  ...
  <script>
    setInterval(() => {
      ...
      xhr.open("GET", "seguimiento.php?codigo=<?= $codigo ?>", true);
      xhr.onload = () => {
        if (xhr.status === 200) {
          const temp = document.createElement("div");
          temp.innerHTML = xhr.responseText;
          const nuevosComentarios = temp.querySelector("#comentarios");
          if (nuevosComentarios) {
            document.getElementById("comentarios").innerHTML = nuevosComentarios.innerHTML;
          }
        }
      };
      xhr.send();
    }, 1000); // actualiza cada 5 segundos para no sobrecargar
  </script>
